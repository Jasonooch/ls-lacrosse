...
/**
 * Form submissions from the website. You can export submissions to CSV using the bulk actions.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface FormSubmission {
  ...
  email?: string | null;
  /**
   * Full raw submission payload from the frontend form
   */
  payload:
    | {
        [k: string]: unknown;
    ...
    | null;
  /**
   * Human-readable version of the form data
   */
  formattedData?: string | null;
  status?: ('new' | 'reviewed' | 'replied' | 'archived') | null;
  /**
   * Optional page path where the form was submitted from
   */
